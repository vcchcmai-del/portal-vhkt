...
BOARD_LABELS = {
    ...
    "NETWORK": "XLCS CĐBR (Tổng sự cố, Số PA phát sinh, XLCS 3h/10h/24h)",
    ...
    "PAKH10K": "PAKH 10k/TB (theo tỉnh)",
    "PAKH10K_TARGET": "Chỉ tiêu/Target PAKH 10k/TB",
    "TL_LAP": "Tỉ lệ lặp (theo tỉnh)",
    "TL_LAP_TARGET": "Chỉ tiêu/Target Tỉ lệ lặp",
    "CL_HUYEN_BD": "XLCS, PAKH 10k/TB, Tỉ lệ lặp — theo huyện (Bình Dương)",
    "CL_HUYEN_BRVT": "XLCS, PAKH 10k/TB, Tỉ lệ lặp — theo huyện (Bà Rịa - Vũng Tàu)",
